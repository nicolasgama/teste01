...
def predict(
    ...
    if agree == True:
        ...
        if len(prompt) > 5000:
            gr.Warning(
                "Text length limited to 5000 characters for this demo, please try shorter text. You can clone this space and edit code for your own usage"
            )
            return (
                None,
                None,
    ...
    with gr.Row():
        with gr.Column():
            input_text_gr = gr.Textbox(
                label="Text Prompt",
                info="One or two sentences at a time is better. Up to 5000 text characters.",
